...
using System.Runtime.InteropServices;
 ...
 namespace GameboyEmulator.Frontend.UI
{
    /// <summary>
    /// ImGui renderer for use with XNA-likes (FNA & MonoGame)
    /// </summary>
    public class ImGuiRenderer : DrawableGameComponent
    {
        private Game _game;
        ...
        private List<Action<GameTime>> layoutActions = new List<Action<GameTime>>();
        
        
        private Texture2D _xnaTexture;
        private IntPtr _imGuiTexture;

        public ImGuiRenderer(Game game) : base(game)
        {
        ...
        public void AddLayout(Action<GameTime> layoutAction)
        {
            this.layoutActions.Add(layoutAction);
        }
        ...
        {
        	_xnaTexture = TextureUtil.CreateTexture(GraphicsDevice, 300, 150, pixel =>
        	{
        		var red = (pixel % 300) / 2;
        	...
        	_imGuiTexture = BindTexture(_xnaTexture);
            base.LoadContent();
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach (var f in layoutActions)
            {
                f(gameTime);
            }
            AfterLayout();
